...
Standard error is effectively the standard deviation of sample means.
...
One approach would be to take multiple samples.
The mean of each of these samples would form a sampling distribution due to variation: some sample means would be lower than the population mean; some sample means would be higher than the sample mean; and many would be the same.
These sample mean values would form a normal distribution around the population mean.

The standard deviation of these sample means would tell us the sample error; that is it would tell us how well our sample means fit the population mean.
