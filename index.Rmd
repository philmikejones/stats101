...
if not os.path.isfile("inst/extdata/food.zip"):
...
if not os.path.isdir("inst/extdata/UKDA-7932-tab"):
    shutil.unpack_archive(
        "inst/extdata/food.zip",
        extract_dir = "inst/extdata/"
    )
```

```{python read-food-data}
food = pd.read_csv(
