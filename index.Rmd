...
You are welcome to use or share these notes, but you must provide an attribution or reference, and you cannot sell them or make money from them (for example by running a training course based on them).

You should note that, as part of the MIT license, I make absolutely no guarantees or warranty that anything is accurate or correct, although I do my best to make sure they are.
