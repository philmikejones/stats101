...
```{r setup}
# list available environments with which -a python
# alternatives are also listed in miniconda/bin
...
I use `python3` to process and analyse the data.
...
```{python load-data}
food = pd.read_csv(
    "inst/extdata/UKDA-7932-tab/tab/lcfs_2013_teaching.tab",
    sep = "\t"
)
```
